...
const PickupScreen = () => {
  ...
  const proceedToCart = () => {
    ...
    // If all fields are filled, proceed to the Cart screen
  ...
  // Calculate one month ahead using moment.js
  const oneMonthLater = moment(currentDate).add(1, 'months').toDate();
    ...
    <>
      <SafeAreaView style={{ paddingTop: 30 }}>
        ...
        <HorizontalDatepicker
          ...
          onSelectedDateChange={(date) => setSelectedDate(moment(date).format('YYYY-MM-DD'))}
